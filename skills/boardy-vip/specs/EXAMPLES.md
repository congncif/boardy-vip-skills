...
- **Specs** (`MICROBOARD_UI.md`, `VIP_COMPONENTS.md`, etc.): rules + detailed explanations, load when uncertain about architecture decisions
- For standard implementation tasks, loading `QUICK_REF.md` + the right example file is usually sufficient
