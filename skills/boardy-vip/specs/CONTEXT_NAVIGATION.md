...
> Companion specs: `COMMUNICATION.md` (Bus patterns), `MICROBOARD_UI.md` (Board lifecycle).
...
- **`COMMUNICATION.md`** — Bus patterns for Board↔Controller communication
- **`MICROBOARD_UI.md`** — Board lifecycle and presentation basics
- **`MICROBOARD_NONUI.md`** — Flow Board coordination patterns

Add to review checklist in `REVIEWER_CHECKLIST.md`:
